...
def main():
    ...
    try:
        ...
        conn = boto3_conn(module, conn_type='client', resource='dynamodb', region=region, endpoint=ec2_url, **aws_connect_kwargs)
    ...
    if module.params['state'] == 'present':
        ...
        response = delete_dynamodb_item(conn, module.params['table'], json.loads(module.params['key']))
        results['old_item'] = response.get('Attributes', {})
